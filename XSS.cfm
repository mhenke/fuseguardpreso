...
<h1>XSS</h1>
<p>The XSS Filter blocks several <a href="A2-CrossSiteScripting.cfm">Cross Site Scripting</a> attack vectors. This filter returns multiple threat levels based on the possible presence of a cross site scripting request.</p>
<hr>
<h2>Example 1</h2>
...
<p><button class="btn btn-primary" name="submit" type="submit">Save changes</button>
  </form>
<hr>
<h2>Example 3</h2>
